...
const ServiceCard: React.FC<CardProps> = ({ title, description, icon }) => {
  return (
    <article className='flex h-[380px] justify-center items-center gap-4 z-10 flex-col px-11 py-7 mb-0 w-full bg-white rounded-[15px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]'>
