...
function ProductSection() {
  return (
    <div className=' snap-normal snap-center flex flex-col justify-start items-center gap-6 text-white bg-primary-100 pt-16 h-[1425px]  z-10'>
      <h1 className='font-extrabold text-5xl uppercase'>Sitio Especializado en Turismo Médico en Cuba</h1>
      <div className='relative flex flex-wrap gap-4'>
        <div className='flex flex-col gap-4'>
          <div className='flex gap-4'>
            <HorizontalLgCard
              title='Programa de Cirugía Estética'
          ...
          <div className='absolute top-[316px] flex gap-4'>
            <VerticalLgCard
              image='/VIDATOX-2.png'
              title='Vidatox Tratamiento para cáncer con productos naturales'
            ...
            <div className='flex flex-col gap-4'>
              ...
              <HorizontalXlCard
                ...
                title='Vacuna para cáncer de pulmón'
